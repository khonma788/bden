## 概要
bden.min.js は、自サイトに電話機能を簡単に導入できるJavaScriptライブラリです、設置者は適宜、運用サイトにJS関数を導入いただきます、CSSと画像は固定URLを参照しますので、ご利用者様の運用サイトに一切干渉いたしません

## 使い方
以下ソースは、必要最低限の範囲であり、バージョン記載が最新とは限りません、当該のコピペではなく必ず…ダウンロードリンクをお使いください
```html
<HTML>
<HEAD>
