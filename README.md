...
必要に応じて、CDN（例：jsDelivr）を使用することも可能です。

CDNを使用する場合は、以下のように読み替えてください：
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/xxxx/style.css">
<script src="https://cdn.jsdelivr.net/xxxx/bden.min.js"></script>
```
※CDNの利用は任意です<br>
※CDNが必要になるのは、index.html修正に留めたい方<br>
※メインブランチ（bden@main）をオススメします、安定稼動の直近タグ（bden@v9.9.9）は予備！とお考えください…使用の際は大値を選択願います
```html
<HTML>
<HEAD>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/khonma788/bden@main/style.css" type="text/css">
<script src="https://cdn.jsdelivr.net/gh/khonma788/bden@main/bden.min.js"></script>
<script>
agent3s('5002:');
</script>
</HEAD>
...
### Bdenサービス
[Top](https://bden.siptables.net) Windows-APIダウンロード, トラシューなど<br>
